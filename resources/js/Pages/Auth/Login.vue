    ...
    <BreezeGuestLayout>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
                ...
                <BreezeInput id="password" type="password" class="mt-1 block w-full text-2xl lg:text-base" v-model="form.password" required autocomplete="current-password" />
            </div>

            <div class="block mt-4">
                <label class="flex items-center">
                    <BreezeCheckbox name="remember" v-model:checked="form.remember" />
                    <span class="ml-2 text-gray-600 text-xl lg:text-base">Ricordami </span>
                </label>
            </div>

            <div class="flex items-center justify-end mt-4">
                <Link v-if="canResetPassword" :href="route('password.request')" class="underline text-xl lg:text-base text-gray-600 hover:text-gray-900">
