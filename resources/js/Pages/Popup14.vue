<template>
  <div v-if="isOpen" class="grid grid-cols-4 gap-x-12 gap-y-2 max-w-fit">
    <button class="z-40 bg-blue-100 hover:bg-blue-200 text-black font-bold rounded h-10 w-10 hover:text-xl" @click="selectReaderForUser('Ether1',$page.props.auth.user)">1</button>
    <button class="z-40 bg-blue-100 hover:bg-blue-200 text-black font-bold rounded h-10 w-10 hover:text-xl" @click="selectReaderForUser('Ether2',$page.props.auth.user)">2</button>
    <button class="z-40 bg-blue-100 hover:bg-blue-200 text-black font-bold rounded h-10 w-10 hover:text-xl" @click="selectReaderForUser('Ether3',$page.props.auth.user)">3</button>
    <button class="z-40 bg-blue-100 hover:bg-blue-200 text-black font-bold rounded h-10 w-10 hover:text-xl" @click="selectReaderForUser('Ether4',$page.props.auth.user)">4</button>
    <button class="z-40 bg-blue-100 hover:bg-blue-200 text-black font-bold rounded h-10 w-10 hover:text-xl" @click="selectReaderForUser('Ether5',$page.props.auth.user)">5</button>
    <button class="z-40 bg-blue-100 hover:bg-blue-200 text-black font-bold rounded h-10 w-10 hover:text-xl" @click="selectReaderForUser('Ether6',$page.props.auth.user)">6</button>
    <button class="z-40 bg-blue-100 hover:bg-blue-200 text-black font-bold rounded h-10 w-10 hover:text-xl" @click="selectReaderForUser('Ether7',$page.props.auth.user)">7</button>
    <button class="z-40 bg-blue-100 hover:bg-blue-200 text-black font-bold rounded h-10 w-10 hover:text-xl" @click="selectReaderForUser('Ether8',$page.props.auth.user)">8</button>
    <button class="z-40 bg-blue-100 hover:bg-blue-200 text-black font-bold rounded h-10 w-10 hover:text-xl" @click="selectReaderForUser('Ether9',$page.props.auth.user)">9</button>
    <button class="z-40 bg-blue-100 hover:bg-blue-200 text-black font-bold rounded h-10 w-10 hover:text-xl" @click="selectReaderForUser('Ether10',$page.props.auth.user)">10</button>
    <button class="z-40 bg-blue-100 hover:bg-blue-200 text-black font-bold rounded h-10 w-10 hover:text-xl" @click="selectReaderForUser('Ether11',$page.props.auth.user)">11</button>
    <button class="z-40 bg-blue-100 hover:bg-blue-200 text-black font-bold rounded h-10 w-10 hover:text-xl" @click="selectReaderForUser('Ether12',$page.props.auth.user)">12</button>
    <button class="z-40 bg-blue-100 hover:bg-blue-200 text-black font-bold rounded h-10 w-10 hover:text-xl" @click="selectReaderForUser('Ether13',$page.props.auth.user)">13</button>
    <button class="z-40 bg-blue-100 hover:bg-blue-200 text-black font-bold rounded h-10 w-10 hover:text-xl" @click="selectReaderForUser('Ether14',$page.props.auth.user)">14</button>
    <button class="z-40 bg-blue-100 hover:bg-blue-200 text-black font-bold rounded h-10 w-10 hover:text-xl" @click="selectReaderForUser('Ether15',$page.props.auth.user)">15</button>
