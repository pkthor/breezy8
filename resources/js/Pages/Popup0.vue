<template>
  <div v-if="isOpen" class="grid grid-cols-4 gap-x-12 gap-y-2 max-w-fit">
    <button class="z-40 bg-blue-100 hover:bg-blue-200 text-black font-bold rounded h-10 w-10 hover:text-xl" @click="selectReaderForUser('Intro1',$page.props.auth.user)">1</button>
    <button class="z-40 bg-blue-100 hover:bg-blue-200 text-black font-bold rounded h-10 w-10 hover:text-xl" @click="selectReaderForUser('Intro2',$page.props.auth.user)">2</button>
    <button class="z-40 bg-blue-100 hover:bg-blue-200 text-black font-bold rounded h-10 w-10 hover:text-xl" @click="selectReaderForUser('Intro3',$page.props.auth.user)">3</button>
    <button class="z-40 bg-blue-100 hover:bg-blue-200 text-black font-bold rounded h-10 w-10 hover:text-xl" @click="selectReaderForUser('Intro4',$page.props.auth.user)">4</button>
    <button class="z-40 bg-blue-100 hover:bg-blue-200 text-black font-bold rounded h-10 w-10 hover:text-xl" @click="selectReaderForUser('Intro5',$page.props.auth.user)">5</button>
  </div>
</template>
