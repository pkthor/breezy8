...
<template>
  ...
  <BreezeAuthenticatedLayout>
    <template #header>
      <h2 class="font-semibold text-3xl lg:text-xl text-gray-800 leading-tight">FAQ</h2>
    </template>
      ...
      <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm lg:rounded-lg">
          <div class="p-6 bg-blue-300 border-b border-gray-200">
            <h1 class="font-semibold text-6xl lg:text-2xl text-black leading-tight mb-4">
              FAQ
            </h1>
            
            <h1 class="font-semibold text-5xl lg:text-xl text-black leading-tight m-auto">
              Perché devo effettuare il “sign in”?
            </h1>

            <p class="p-2 mb-2 text-4xl lg:text-base">
