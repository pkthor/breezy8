<template>
  <div v-if="isOpen" class="grid grid-cols-4 gap-x-2 lg:gap-x-12 gap-y-2 max-w-fit">
    <button class="z-40 bg-blue-100 hover:bg-blue-200 text-black text-3xl lg:text-base font-bold rounded h-20 w-20 lg:h-10 lg:w-10 hover:text-xl" @click="selectReaderForUser('Giarom1',$page.props.auth.user)">1</button>
  </div>
</template>
...
var allReaders = [
  {
    ...
    book: "Giarom",
    chapter: 1,
    narrator: "Luana Grieco",
    narratorImageName: "LuanaGrieco",
